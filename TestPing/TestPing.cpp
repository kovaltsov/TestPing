...
// TestPing.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTestPingApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTestPingApp

CTestPingApp::CTestPingApp()
{
...
// Единственный объект CTestPingApp

CTestPingApp theApp;


// Инициализация CTestPingApp

BOOL CTestPingApp::InitInstance()
{
